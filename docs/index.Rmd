...
kable(top_10_deaths, col.names = c("State", "Deaths per 100,000", "Low Mask Usage Percent", "Vaccine Hesitancy Percent", "Percentage of Votes for Biden", "Percentage of Votes for Trump"))
``` 
```
